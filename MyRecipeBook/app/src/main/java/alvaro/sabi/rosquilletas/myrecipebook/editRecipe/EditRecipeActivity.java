package alvaro.sabi.rosquilletas.myrecipebook.editRecipe;
...
import alvaro.sabi.rosquilletas.myrecipebook.dialogs.EditRecipeDialog;
import alvaro.sabi.rosquilletas.myrecipebook.dialogs.ReturnRecipeDialog;
...
public class EditRecipeActivity extends AppCompatActivity implements ToastMessages, EditRecipeInterface {
    ...
    public void finishRecipe(View view) {
        ...
        {
            //En caso afirmativo, se le pregunta al usuario si efectivamente quiere guardar la receta
            showSaveDialog();
        }
    }

    //Método que es llamado desde un Dialog cuando el usuario acepta guardar la receta
